        ...
        <div class="container-fluid">
          <div class="row" data-aos="fade">
            ...
            <div class="container" style="position: center;">
              <CENTER>
<img class="responsive" src="img/jhar/p.png">
</CENTER>
</div>
                        ...
                        <div class="container box_1170">
                            ...
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25" style="text-align: center;">Emergency Speciality Hospitals</h2>
                                    <?php
                                  $query = "SELECT * FROM healthcare WHERE state='manipur'";
...
<div class="container table-responsive">
  <h1 style="text-align: center;">HEALTH-CARE CENTERS IN MANIPUR</h1>
  <br><br>
  <CENTER>
  <div ><a href="http://nrhmmanipur.org/?page_id=2602">
