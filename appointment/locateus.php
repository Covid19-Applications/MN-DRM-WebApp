...
<body style="background-image: url(images/p.png);background-size: 500px;">
	<a href="cover.php" class="btn btn-link btn-lg active" role="button" aria-pressed="true">
    <img src="../img/home-icon.png"><img src="../img/arrow.png"></a>
	<form action="locateus.php" method="post">
	<div class="sucontainer" style="background-color:#121212">
		<ul style="background-color:#121212">			
			<label><b>SEARCH DOCTORS</b></label>
...
?>
	...
	<div class="container">
			<input type="button" href="cover.php" value="Back"/>
		</div>
</body>
</html>