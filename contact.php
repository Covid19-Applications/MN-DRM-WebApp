    ...
    <div id="heroCarousel" class="container carousel carousel-fade" data-ride="carousel">
      ...
      <div class="carousel-item active">
        <div class="carousel-container"><br><br><br>
         <img class="animated fadeInDown" src="img/haryana/aa.png" >
        </div>
      </div>
        ...
        <div class="container">
            ...
            <div class="row">
             ...
             <img  class="responsive" src="img/logo1.png"></a>
                <p class="d-flex">
                  <span class="ion-ios-location icon mr-5" style="color: slategray"></span>
                  <span>Saidabad, Hyderabad, Telangana,India</span>
                </p>

                <p class="d-flex">
                  <span class="ion-ios-telephone icon mr-5" style="color: slategray"></span>
                  <span>+91 XXXXXXXXXX</span>
                </p>

                <p class="d-flex">
                  <span class="ion-android-mail icon mr-5" style="color: slategray"></span>
